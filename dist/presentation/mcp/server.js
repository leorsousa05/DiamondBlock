...
export function resolveSearchScope(input) {
    if (input.scope)
        return Scope.normalize(input.scope);
    if (input.project_id)
        return Scope.fromTypeAndProject('project', input.project_id);
    return undefined;
}
        ...
        try {
            switch (name) {
                case 'get_context': {
                    ...
                    const useCase = new GetContextUseCase(container.memoryRepository, container.sessionRepository);
                ...
                case 'search_memory': {
                    ...
                    const useCase = new SearchMemoryUseCase(container.memoryRepository, container.vectorIndex, container.embeddingProvider);
                    const result = await useCase.execute({
                        query: input.query,
                        scope,
                        limit: input.limit,
                ...
                case 'save_memory': {
                    ...
                    const useCase = new SaveMemoryUseCase(container.memoryRepository, container.vectorIndex, container.embeddingProvider, container.enrichmentService);
                    const result = await useCase.execute({
                        title: input.title,
                ...
                case 'update_memory': {
                    ...
                    const useCase = new UpdateMemoryUseCase(container.memoryRepository, container.vectorIndex, container.embeddingProvider, container.enrichmentService);
                ...
                case 'delete_memory': {
                    ...
                    const useCase = new DeleteMemoryUseCase(container.memoryRepository, container.vectorIndex);
