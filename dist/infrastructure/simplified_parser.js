...
export class SimplifiedParser {
    ...
    canParse(file) {
        ...
        return this.options.patterns.fileExtensions.some((ext) => lower.endsWith(ext.startsWith('.') ? ext : `.${ext}`));
    }
    ...
    findSymbolEndLine(lines, startIndex) {
...
//# sourceMappingURL=simplified_parser.js.map